...
const SCENES: Record<string, Scene> = {
  sync: {
    ...
    lines: [
      ...
      out([
        { t: "✔ ", c: "term-ok" },
        { t: "anthropics/skills    ", c: "term-cmd" },
        { t: "(3 skills, 6.4s)", c: "term-mute" },
      ]),
      out([
        { t: "✔ ", c: "term-ok" },
        { t: "vercel-labs/skills   ", c: "term-cmd" },
        { t: "(1 skill,  6.3s)", c: "term-mute" },
      ]),
      out([
        { t: "✔ ", c: "term-ok" },
        { t: "shadcn/ui            ", c: "term-cmd" },
        { t: "(1 skill,  7.1s)", c: "term-mute" },
      ]),
      out([
        { t: "✔ ", c: "term-ok" },
        { t: "prisma/skills        ", c: "term-cmd" },
        { t: "(1 skill,  7.5s)", c: "term-mute" },
      ]),
      blank(),
      out([{ t: "6 skills added, 0 already up to date", c: "term-ok" }]),
    ],
  },
